...
> **Source**: [CL4R1T4S](https://github.com/elder-plinius/CL4R1T4S) by [elder-plinius](https://github.com/elder-plinius) — ANTHROPIC/CLAUDE-FABLE-5.md  
> **Original License**: Permissively shared in the public CL4R1T4S repository for educational reference.  
> **Integration Note**: This document is the system prompt for **Claude Fable 5**, Anthropic's most advanced generally available model. It is included here as a reference for AI behavior design, prompt engineering, and safety architecture — relevant context for anyone building or studying advanced AI agents.
